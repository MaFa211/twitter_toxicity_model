  ...
  def sample_keywords(self, df, N, group):
    ...
    if match_df.shape[0] <= N / 3:
      print(
        ...
        "instead of",
        N / 3,
        "examples from race focused tweets due to insufficient outputs",
      )
      sample_df = match_df
...
#       raise ValueError(
#         f"Language not in the outputs {language}. Accepted values are " f"{self.accepted_languages}"
#       )
...
#       if language == "es":
#         print(".... additional adhoc outputs")
